...
|---|---|---|
| NuGet CI | `eac-nuget-ci` | Implementado con integración `default`, `kafka`, `postgresql` o `mongodb` seleccionable |
...
compila, selecciona las pruebas `default`, `kafka`, `postgresql` o `mongodb`, crea el candidato y lo
