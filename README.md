...
|---|---|---|
| NuGet CI | `eac-nuget-ci` | Implementado con integración `default`, `kafka`, `postgresql`, `mongodb` o `elasticsearch` seleccionable |
...
compila, selecciona las pruebas `default`, `kafka`, `postgresql`, `mongodb` o `elasticsearch`, crea el candidato y lo
