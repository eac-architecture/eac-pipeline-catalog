...
| PC-002K | variante CI NuGet con Kafka efímero no privilegiado | PC-002 y consumidor Kafka real | Completado | Task reusable con sidecar fijado; mismo build y pruebas contra `KAFKA_BOOTSTRAP_SERVERS` |
