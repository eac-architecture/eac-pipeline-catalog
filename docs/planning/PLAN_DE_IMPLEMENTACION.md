...
| PC-002 | perfil `packages/nuget` CI | PC-001 | Completado | `v0.4.6` ejecuta Tasks .NET nativas, checkout privado aislado y eventos Pipelines as Code de PR/push; once componentes mantienen bindings mínimos verificados |
...
La baseline operativa actual es `v0.4.6`. Los perfiles NuGet compartidos cubren CI,
